...
(function($){
	$(document).ready(function(){
		$('#product_select').change(function(){
			// Retrieve start date
			$.post(ajaxurl, {action: 'jigoshop_order_export_get_product_date', id: $(this).val()}, function(response){
				// Set calendar widgets
				jigoshop_order_export_calendar_format($('#jigoshop-order-export-start-date'), new Date(response));
				jigoshop_order_export_calendar_format($('#jigoshop-order-export-end-date'), new Date());
				jigoshop_order_export_enable_calendar(new Date(response));
			});
		});
	});
})(jQuery);
...
function jigoshop_order_export_enable_calendar(start_date){
